...
const PHASES: Phase[] = [
  ...
  {
    id: "p2",
    name: "TARX Quantum Engine",
    timeframe: "Q1 2026 – Q2 2026",
    status: "active",
    items: [
      { label: "TARX Quantum Engine v1.0 — 5 solver types", done: true },
      { label: "quantum.tarx.com live", done: true },
      { label: "Origin Quantum algorithm stack integrated (13 modules)", done: true },
      { label: "Mesh distribution — route jobs across nodes", done: false },
      { label: "Hardware bridge — Origin Quantum 72-qubit Wukong", done: false },
    ],
    insight: "Engine is live with 5 solvers: optimize, search, classify, cluster, binary. 13 quantum algorithm modules from Origin Quantum integrated. Next: distribute across mesh and bridge to real quantum hardware.",
  },
  {
    id: "p3",
